...
function setup(){
    ...
    var stripeTex = THREE.ImageUtils.loadTexture("tex/thinstripe.png");
    ...
    for(var i = 0; i < textures.length; i++){
        var material = new THREE.ShaderMaterial( {
            uniforms: {        
                ...
                texture2: {type: "t", value: stripeTex},
        ...
        var mesh = new THREE.Mesh(new THREE.PlaneBufferGeometry(1600, 1000, 100,100), material);
        mesh.position.z = -i;
        // mesh.position.x = 2*i;

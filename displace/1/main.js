...
function setup(){
    ...
    var textures = [];
    var strings = [
        "../../cloth/tex/redstripe.png", 
        "../../cloth/tex/greenstripe.png", 
        "../../cloth/tex/bluestripe.png",
        "../../cloth/tex/whitestripe.png",
        "../../cloth/tex/stripe.png"
    ]
    for(var i = 0; i < 3; i++){
    ...
    for(var i = 0; i < 3; i++){
        var material = new THREE.ShaderMaterial( {
            ...
            vertexShader: document.getElementById( 'sineWaveVs' ).textContent,
            fragmentShader: document.getElementById( 'sineWaveFs' ).textContent,
            side: 2,
            transparent: true  
        } );
        materials.push(material);
        var mesh = new THREE.Mesh(new THREE.PlaneBufferGeometry(10,10, 1000, 1000), material);
        mesh.position.z = -i;
        // mesh.rotation.z = Math.PI*i*0.01;
        scene.add(mesh);
    }


    // mesh2 = new THREE.Mesh(new THREE.PlaneBufferGeometry(50,50, 1000, 1000), material);
...
function draw(){
    ...
    //     //         meshes[j].geometry.vertices[i].x += Math.sin((i-i/2)/500.001 + time);
